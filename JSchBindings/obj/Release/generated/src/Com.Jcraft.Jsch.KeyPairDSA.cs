...
namespace Com.Jcraft.Jsch {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='KeyPairDSA']"
	[global::Android.Runtime.Register ("com/jcraft/jsch/KeyPairDSA", DoNotGenerateAcw=true)]
	public partial class KeyPairDSA : global::Com.Jcraft.Jsch.KeyPair {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/jcraft/jsch/KeyPairDSA", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (KeyPairDSA); }
		}

		protected KeyPairDSA (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_jcraft_jsch_JSch_arrayBarrayBarrayBarrayBarrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='KeyPairDSA']/constructor[@name='KeyPairDSA' and count(parameter)=6 and parameter[1][@type='com.jcraft.jsch.JSch'] and parameter[2][@type='byte[]'] and parameter[3][@type='byte[]'] and parameter[4][@type='byte[]'] and parameter[5][@type='byte[]'] and parameter[6][@type='byte[]']]"
		[Register (".ctor", "(Lcom/jcraft/jsch/JSch;[B[B[B[B[B)V", "")]
		public KeyPairDSA (global::Com.Jcraft.Jsch.JSch p0, byte[] p1, byte[] p2, byte[] p3, byte[] p4, byte[] p5) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			if (GetType () != typeof (KeyPairDSA)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Lcom/jcraft/jsch/JSch;[B[B[B[B[B)V", new JValue (p0), new JValue (native_p1), new JValue (native_p2), new JValue (native_p3), new JValue (native_p4), new JValue (native_p5)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lcom/jcraft/jsch/JSch;[B[B[B[B[B)V", new JValue (p0), new JValue (native_p1), new JValue (native_p2), new JValue (native_p3), new JValue (native_p4), new JValue (native_p5));
				if (p1 != null) {
			...
			if (id_ctor_Lcom_jcraft_jsch_JSch_arrayBarrayBarrayBarrayBarrayB == IntPtr.Zero)
				id_ctor_Lcom_jcraft_jsch_JSch_arrayBarrayBarrayBarrayBarrayB = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/jcraft/jsch/JSch;[B[B[B[B[B)V");
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_jcraft_jsch_JSch_arrayBarrayBarrayBarrayBarrayB, new JValue (p0), new JValue (native_p1), new JValue (native_p2), new JValue (native_p3), new JValue (native_p4), new JValue (native_p5)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_jcraft_jsch_JSch_arrayBarrayBarrayBarrayBarrayB, new JValue (p0), new JValue (native_p1), new JValue (native_p2), new JValue (native_p3), new JValue (native_p4), new JValue (native_p5));
			if (p1 != null) {
				JNIEnv.CopyArray (native_p1, p1);
				JNIEnv.DeleteLocalRef (native_p1);
			}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='KeyPairDSA']/constructor[@name='KeyPairDSA' and count(parameter)=1 and parameter[1][@type='com.jcraft.jsch.JSch']]"
		[Register (".ctor", "(Lcom/jcraft/jsch/JSch;)V", "")]
		public KeyPairDSA (global::Com.Jcraft.Jsch.JSch p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Jcraft.Jsch.KeyPairDSA __this = global::Java.Lang.Object.GetObject<global::Com.Jcraft.Jsch.KeyPairDSA> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual int KeySize {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='KeyPairDSA']/method[@name='getKeySize' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override int KeyType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='KeyPairDSA']/method[@name='getKeyType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override global::Com.Jcraft.Jsch.ISignature Verifier {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='KeyPairDSA']/method[@name='getVerifier' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='KeyPairDSA']/method[@name='forSSHAgent' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='KeyPairDSA']/method[@name='getSignature' and count(parameter)=1 and parameter[1][@type='byte[]']]"
