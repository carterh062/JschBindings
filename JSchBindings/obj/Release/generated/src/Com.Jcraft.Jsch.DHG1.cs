...
namespace Com.Jcraft.Jsch {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='DHG1']"
	[global::Android.Runtime.Register ("com/jcraft/jsch/DHG1", DoNotGenerateAcw=true)]
	public partial class DHG1 : global::Com.Jcraft.Jsch.KeyExchange {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/jcraft/jsch/DHG1", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (DHG1); }
		}

		protected DHG1 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='DHG1']/constructor[@name='DHG1' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public DHG1 () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (DHG1)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Jcraft.Jsch.DHG1 __this = global::Java.Lang.Object.GetObject<global::Com.Jcraft.Jsch.DHG1> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override string KeyType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='DHG1']/method[@name='getKeyType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override int State {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='DHG1']/method[@name='getState' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='DHG1']/method[@name='init' and count(parameter)=5 and parameter[1][@type='com.jcraft.jsch.Session'] and parameter[2][@type='byte[]'] and parameter[3][@type='byte[]'] and parameter[4][@type='byte[]'] and parameter[5][@type='byte[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch']/class[@name='DHG1']/method[@name='next' and count(parameter)=1 and parameter[1][@type='com.jcraft.jsch.Buffer']]"
