...
namespace Com.Jcraft.Jsch.Jce {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.jcraft.jsch.jce']/class[@name='ARCFOUR256']"
	[global::Android.Runtime.Register ("com/jcraft/jsch/jce/ARCFOUR256", DoNotGenerateAcw=true)]
	public partial class ARCFOUR256 : global::Java.Lang.Object, global::Com.Jcraft.Jsch.ICipher {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/jcraft/jsch/jce/ARCFOUR256", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ARCFOUR256); }
		}

		protected ARCFOUR256 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.jcraft.jsch.jce']/class[@name='ARCFOUR256']/constructor[@name='ARCFOUR256' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public ARCFOUR256 () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (ARCFOUR256)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Jcraft.Jsch.Jce.ARCFOUR256 __this = global::Java.Lang.Object.GetObject<global::Com.Jcraft.Jsch.Jce.ARCFOUR256> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual int BlockSize {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch.jce']/class[@name='ARCFOUR256']/method[@name='getBlockSize' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual int IVSize {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch.jce']/class[@name='ARCFOUR256']/method[@name='getIVSize' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual bool IsCBC {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch.jce']/class[@name='ARCFOUR256']/method[@name='isCBC' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch.jce']/class[@name='ARCFOUR256']/method[@name='init' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='byte[]'] and parameter[3][@type='byte[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch.jce']/class[@name='ARCFOUR256']/method[@name='update' and count(parameter)=5 and parameter[1][@type='byte[]'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='byte[]'] and parameter[5][@type='int']]"
