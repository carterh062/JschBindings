...
namespace Com.Jcraft.Jsch.Jcraft {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.jcraft.jsch.jcraft']/class[@name='HMACSHA196']"
	[global::Android.Runtime.Register ("com/jcraft/jsch/jcraft/HMACSHA196", DoNotGenerateAcw=true)]
	public partial class HMACSHA196 : global::Com.Jcraft.Jsch.Jcraft.HMACSHA1 {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/jcraft/jsch/jcraft/HMACSHA196", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (HMACSHA196); }
		}

		protected HMACSHA196 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.jcraft.jsch.jcraft']/class[@name='HMACSHA196']/constructor[@name='HMACSHA196' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public HMACSHA196 () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (HMACSHA196)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Jcraft.Jsch.Jcraft.HMACSHA196 __this = global::Java.Lang.Object.GetObject<global::Com.Jcraft.Jsch.Jcraft.HMACSHA196> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override int BlockSize {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch.jcraft']/class[@name='HMACSHA196']/method[@name='getBlockSize' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.jcraft.jsch.jcraft']/class[@name='HMACSHA196']/method[@name='doFinal' and count(parameter)=2 and parameter[1][@type='byte[]'] and parameter[2][@type='int']]"
